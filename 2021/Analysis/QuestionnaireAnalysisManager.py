...
class QUESTIONNAIRE_Analysis:
	def __init__(self):
		...
		self.figure = FIG()
		self.main('Analysis/ExData/Questionnaire/CutData/AllQuestionnaireData_20220202.xlsx')
	...
	def A_TLX(self):
		...
		self.awwl_3_df = self.make_df(self.awwl_df,key='3')
		self.awwl_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_TLX.xlsx')
		...
		self.figure.MeanBoxPlot(self.awwl_3_df,ylabel='AWWL',filename='TLX_AWWL_3')
	...
	def A_MS(self):
		...
		self.ownership_3_df = self.make_df(self.ownership_df,key='3')
		self.agency_3_df = self.make_df(self.agency_df,key='3')
		self.ownership_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Ownership.xlsx')
		self.agency_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Agency.xlsx')

		self.ownership_31_df = self.make_df(self.ownership_df,key='3-1')
		self.agency_31_df = self.make_df(self.agency_df,key='3-1')
		self.ownership_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/31_Ownership.xlsx')
		self.agency_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/31_Agency.xlsx')
		...
		self.figure.MeanBoxPlot(df=self.ownership_3_df,ylabel='Ownership - Ownership Control',filename='OWNERSHIP_3')

		self.figure.MeanBoxPlot(df=self.agency_3_df,ylabel='Agency - Agency Control',filename='AGENCY_3')

		self.figure.MeanBoxPlot(df=self.ownership_31_df,ylabel='Ownership - Ownership Control',filename='OWNERSHIP_31')

		self.figure.MeanBoxPlot(df=self.agency_31_df,ylabel='Agency - Agency Control',filename='AGENCY_31')
	...
	def A_MD(self):
		...
		self.md_3_df = self.make_df(self.md_df,key='3')
		self.md_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_MD.xlsx')
		...
		self.figure.MeanBoxPlot(self.md_3_df,ylabel='Difference in mental distance',filename='MD_3')
	...
	def A_SE(self):
		...
		self.SE_Q1_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Q1.xlsx')
		self.SE_Q2_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Q2.xlsx')
		self.SE_Q3_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Q3.xlsx')
		self.SE_Q4_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Q4.xlsx')
		self.SE_Q5_3_df.to_excel('Analysis/ExData/Questionnaire/CutData/3_Q5.xlsx')
		...
		self.figure.MeanBoxPlot(df=self.SE_Q1_3_df,ylabel='Questionnaire rating',filename='Q1_3')
		self.figure.MeanBoxPlot(df=self.SE_Q2_3_df,ylabel='Questionnaire rating',filename='Q2_3')
		self.figure.MeanBoxPlot(df=self.SE_Q3_3_df,ylabel='Questionnaire rating',filename='Q3_3')
		self.figure.MeanBoxPlot(df=self.SE_Q4_3_df,ylabel='Questionnaire rating',filename='Q4_3')
		self.figure.MeanBoxPlot(df=self.SE_Q5_3_df,ylabel='Questionnaire rating',filename='Q5_3')

if __name__ in '__main__':
	questionnaireAnalysisExport = QUESTIONNAIRE_Export('AllQuestionnaireData_20220224.xlsx')
	# questionnaireAnalysis = QUESTIONNAIRE_Analysis()